...
for venue in conference_paper_list_dict:
    for conf_year, paper_list in conference_paper_list_dict[venue].items():
        ...
        if conf_year >= 1995 and conf_year <= 2000:
            ...
            d_index_dict5, d_rank5 = get_ideal_tniceness_distance_ranklist(G, paper_list, conf_year + 5, paper_year_dict, paper_cum_citation_dict)
            # print()
